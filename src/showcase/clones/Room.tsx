...
import room from './scene-transformed.glb'

const Screen = () => {
  const ref: any = useRef()
  useFrame(({ clock }) => {
    const time = clock.elapsedTime
    const sin = Math.sin(time) + Math.cos(time * 10)
...
const Lights = () => {
  ...
  useFrame(() => {
    ...
    ref.current.traverse((obj: any) => obj.isMesh && obj.material.emissive.lerp(color, 0.01))
  })
  ...
  return (
    <group {...props} dispose={null}>
      <group name='_Chambre' rotation={[-Math.PI / 2, 0, 0]}>
        ...
        <Clone object={Object.values(nodes).filter((n: any) => n.name.startsWith('Tapis_')) as any} receiveShadow />
        ...
        <Clone object={Object.values(nodes).filter((n: any) => n.name.startsWith('Vetement_')) as any} />
