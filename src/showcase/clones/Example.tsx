  ...
  return (
    <>
      ...
      <Canvas orthographic shadows dpr={[1, 2]} camera={{ position: [10, 10, 10], zoom: 10 }}>
        <color attach='background' args={[0x252530]} />
        ...
        <BakeShadows />
        <OrbitControls makeDefault minAzimuthAngle={0} maxAzimuthAngle={Math.PI / 2} minPolarAngle={Math.PI / 3} maxPolarAngle={Math.PI/3} enableZoom enablePan zoomSpeed={0.3} />
